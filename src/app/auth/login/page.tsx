export default function LoginPage() {
	return (
		<form className="flex w-full max-w-md flex-col rounded space-y-4 bg-[#141414] bg-opacity-90 px-4 py-8 shadow-lg">
			...
			<div className="mt-8 flex flex-col space-y-4">
				...
				<div className="flex flex-col space-y-1">
					<label htmlFor="password" className="text-sm font-bold text-gray-500">
						Password
					</label>
					<input
						type="password"
